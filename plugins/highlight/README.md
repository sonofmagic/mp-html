...
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+javadoclike+jsdoc+less+markdown+scss+sql+toml+typescript